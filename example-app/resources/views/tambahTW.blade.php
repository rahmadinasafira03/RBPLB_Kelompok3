...
@section ('tombol')
    <a href="/products"> <button type="button" class="btn btn-outline-primary">Kembali </button></a>
@endsection

@section('konten')
	<form action="/products/storeTW" method="post">
		{{ csrf_field() }}
        ...
        <input type="submit" button type="button" class="btn btn-primary" value="Simpan Data">
    </form>
@endsection
